export interface Project {
  ...
  //NOTE: **Do NOT indent the markdown as it will break text-wrapping**...Learned this the hard way
...
markdown: `
A project aimed at enhancing the collaboration process within a journalistic ecosystem by creating a scalable, event-based system for future use by the university's journalism study student body.
`,
        published: true,
